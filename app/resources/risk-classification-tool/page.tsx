    ...
    <div>
      ...
      <div className="container">
        <div className="e-con-inner !pt-20 md:!pt-28">
          <motion.p
            className="mb-8 w-3/5 text-muted-foreground"
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, amount: 0.5 }}
            transition={{
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 ml-1">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <label
                    ...
                    className="text-sm leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 pt-0.5"
                  >
                    Manipulation of human behavior against user&apos;s free will
                  </label>
                </div>
              </div>
              ...
              <Alert className="bg-green-50 text-green-800 border-green-200">
                <AlertDescription className="flex items-start gap-2">
                  <span>
                    ✓ If you selected any of these, your AI system is classified
                    as <span className="font-bold">Unacceptable Risk</span> and
